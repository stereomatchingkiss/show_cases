...
/**
 * A class use to download the file from url and save it into the local disk.
 * Benefits of this class is it will save the file as the name of the file +
 * if there exsit same file name, it will append number behind it.
 * Ex : lily.jpg, lily(0).jpg, lily(1).jpg ...
 * @code
 * //In constructor
 ...
 * auto const unique_id = manager_->append(request, "train_data/", 1000 * 60);
