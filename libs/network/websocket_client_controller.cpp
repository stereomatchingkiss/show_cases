    ...
    worker_{new websocket_client_worker}
{
    ...
    connect(this, &websocket_client_controller::initialize, worker_, &websocket_client_worker::create_connection);
    connect(this, &websocket_client_controller::open, worker_, &websocket_client_worker::open);
    connect(this, &websocket_client_controller::reopen_if_needed, worker_, &websocket_client_worker::restart_if_needed);
